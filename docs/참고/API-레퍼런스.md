...
- 서버/클라이언트 내부 코드의 함수/변수명은 `camelCase`
- API 계약(JSON 요청/응답) 키는 `snake_case`
- 쿼리 파라미터는 기존 관례를 유지하되, 문서에서 표준 표기를 명시
...
- 유료화(결제/권한/웹훅): `docs/서버/API/수익화.md`
- 공유 이벤트: `docs/서버/API/공유-이벤트.md`
- UX 이벤트: `docs/서버/API/UX-이벤트.md`
- 관리자 운영: `docs/서버/API/관리자-운영.md`
...
- 유료화 계약서: `docs/수익화/API-계약서-v1.md`
- 유료화 운영 런북: `docs/수익화/3단계-운영-런북.md`
- 서버 문서 허브: `docs/문서-허브.md`
